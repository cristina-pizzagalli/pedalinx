    ...
    <div id='main'>
      <div class='content'>
        <div class='wrapper about one'>
          <div class='left'>
            <h2>
              <?php perch_content('title-1'); ?>
            </h2>
            <?php perch_content('our-story-description'); ?>
          </div>
          <div class='right'>
            <h5>
              <?php perch_content('pullquote'); ?>
            </h5>
          </div>
          <div class='clear'></div>
          <div class='divide-about'></div>
        </div>
      </div>
      <div class='content'>
        <div class='wrapper about two'>
          <div class='left'>
            <h2>
              <?php perch_content('title-2'); ?>
            </h2>
            <?php perch_content('our-store-description'); ?>
          </div>
          <div class='right'>
            <?php perch_content('our-store-photo'); ?>
            <div class='clear'></div>
            <a class='orange-lrg' href='<?php perch_content('call-to-action-link'); ?>contact.php'>
      ...
      <div class='content'>
        <div class='wrapper about three'>
          <h2>
            <?php perch_content('title-3'); ?>
          </h2>
          <div class='staff'>
            <?php perch_content('staff-listing'); ?>
            <div class='clear'></div>
          </div>
        </div>
        <div class='clear'></div>
