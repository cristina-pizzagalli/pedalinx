...
<html lang='en'>
  ...
  <body ontouchstart="" class='services'>
    <header>
      <div class='logo'>
        <a href='index.php'>
      ...
      <div class='content'>
        <div class='wrapper services'>
          <div class='left'>
            ...
            <?php perch_content('services-description'); ?>
            <h3>
              <?php perch_content('call-to-action-title'); ?>
            </h3>
            <a class='orange-lrg' href='<?php perch_content('call-to-action-link'); ?>'>
          ...
          <div class='right'>
            ...
            <?php perch_content('services-listing'); ?>
            <h4>
              <?php perch_content('title-3'); ?>
            </h4>
            <?php perch_content('repair-packages'); ?>
            <?php perch_content('contact-call-to-action'); ?>
          </div>
          <div class='clear'></div>
        </div>
      </div>
